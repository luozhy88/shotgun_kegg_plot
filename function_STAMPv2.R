...
pathway_pdf(meta_info=metadata,pathway_df=kegg.table.df,meta_col=c("sampleID", "Group"),out.name= glue::glue("Product_"),height = 2,padj=0.05)

pathway_pdf(meta_info=metadata,pathway_df=kegg.table.df,meta_col=c("sampleID", "Group"),out.name= glue::glue("Product_"),height = 2,padj=0.01)
